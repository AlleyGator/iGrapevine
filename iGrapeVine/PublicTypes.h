...
#ifndef iGrapeVine_PublicTypes_h
#define iGrapeVine_PublicTypes_h
...
//End Enum
static const int MIN_ANNOUNCE = atCharacters;
static const int MAX_ANNOUNCE = atStatus;
...
//'
typedef enum ExperienceChangeType {
    ecEarned = 0,
    ecDeducted = 1,
    ecSetEarned = 2,
    ecSpent = 3,
...
//'
typedef enum RumorCategoryType {
    rtGeneral = 0,
    rtInfluence = 1,
    rtRace = 2,
    rtGroup = 3,
...
static const int MIN_OUTFORMAT = ofText;
static const int MAX_OUTFORMAT = ofHTML;
